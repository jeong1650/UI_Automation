...
public class OSC_700_SRH_01520 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-21
	 * @ ExpectedResult = 메인 > 검색 > 부가정보 off > 상품 상세 > 상단 back 선택 시 부가정보 on 상태 검색 결과 화면 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_SRH_01520() throws Exception {
		TCID = "OSC700_05_검색_01520 상단 Back 버튼 선택 (부가정보 off 상태인 경우)";
		result = "FAIL";
