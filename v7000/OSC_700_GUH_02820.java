...
public class OSC_700_GUH_02820 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-01
	 * @ ExpectedResult = 앱&라이프 메인 > 임의의 앱 선택 > [검색] 선택 시 검색 화면 이동
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_GUH_02820() throws Exception {
		TCID = "OSC700_01_Home_02820  임의의 앱 선택";
		result = "FAIL";
