...
public class OSC_700_GUH_00740 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-01
	 * @ ExpectedResult = 게임 추천 화면 > 최하단 Footer 영역 정상 노출
	 * @ Editor = 
	 * @ EditDate = 2020-10-15
	 * @ 타이틀 상이하게 인식되는 단말 대응
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_GUH_00740() throws Exception {
		TCID = "OSC700_01_Home_00740 최하단 Footer 영역 확인";
		result = "FAIL";
		...
		Thread.sleep(3000);
		driver.findElementByXPath("//android.widget.Button[@text='추천']").click();
