...
public class OSC_700_MYP_00800 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-10
	 * @ ExpectedResult = 마이페이지 > 원스토어 캐쉬 > 적립내역 / 사용내역 탭
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_00800() throws Exception {
		TCID = "OSC700_04_MY_00800 적립내역/사용내역 탭 (적립내역/사용내역이 없는 경우)";
		result = "FAIL";
		...
		driver.findElementById("com.skt.skaf.A000Z00040:id/menu_onestore_cash").click();
		
		Thread.sleep(3000);
		driver.findElementByXPath("//*[@text='원스토어 캐쉬']").isDisplayed();
