...
public class OSC_700_MYP_00520 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-10
	 * @ ExpectedResult = 마이페이지 > 내 쿠폰 > 편집모드 > 쿠폰 삭제 > 완료 선택시 반영
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_00520() throws Exception {
		TCID = "OSC700_04_MY_00520 [완료] 선택";
		result = "FAIL";
