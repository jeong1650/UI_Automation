...
public class OSC_700_SRH_00851 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-17
	 * @ ExpectedResult = 메인 > 검색 > 검색 결과 화면 > 상하 스크롤시 검색창 영역 고정
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_SRH_00851() throws Exception {
		TCID = "OSC700_05_검색_00851 검색 결과 화면";
		result = "FAIL";
