...
public class OSC_700_GUH_04310 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-03
	 * @ ExpectedResult = 앱&라이프 추천 화면 > LG U+ 통신 판매업 신고번호 선택 시 LG U+ 공정위 사업자 정보 고지 화면 이동
	 * @ Editor = 
	 * @ EditDate = 2020-10-15
	...
	@Test
	public void OSC_GUH_04310() throws Exception {
		TCID = "OSC700_01_Home_04310  최하단 Footer 영역";
		result = "FAIL";
