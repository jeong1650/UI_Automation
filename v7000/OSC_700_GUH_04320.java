...
public class OSC_700_GUH_04320 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-03
	 * @ ExpectedResult = 앱&라이프 화면 > ONEstore 통신 판매업 신고번호 선택 시 ONEstore 공정위 사업자 정보 고지 화면 이동
	 * @ Editor = 
	 * @ EditDate = 2020-10-15
	...
	@Test
	public void OSC_GUH_04320() throws Exception {
		TCID = "OSC700_01_Home_04320  최하단 Footer 영역";
		result = "FAIL";
		...
		assertEquals("통신판매업신고 : 제2016-성남분당-0175호", downscroll(By.id("com.skt.skaf.A000Z00040:id/tv_seller_info_onestore")).getText());
