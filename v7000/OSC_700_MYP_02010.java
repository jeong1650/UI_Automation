...
public class OSC_700_MYP_02010 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-10
	 * @ ExpectedResult = 마이페이지 > 구매내역 > [편집] 선택 시 편집 화면 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_02010() throws Exception {
		TCID = "OSC700_04_MY_02010 [편집] 선택 (구매한 상품이 있는 경우)";
		result = "FAIL";
		...
		driver.findElementById("com.skt.skaf.A000Z00040:id/purchase_delete_btn").isDisplayed();
