...
public class OSC_700_CAT_00110 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-03
	 * @ ExpectedResult = 유료 상품, 외부결제를 지원하는 게임 / 앱 상품 상세 > 외부결제 더 보기 선택 시 팝업 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_CAT_00110() throws Exception {
		TCID = "OSC700_03_APP_00110 외부결제 더보기(>) 선택 (유료 상품이며, 외부결제를 지원하는 상품)";
		result = "FAIL";
