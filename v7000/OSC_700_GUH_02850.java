...
public class OSC_700_GUH_02850 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-01
	 * @ ExpectedResult = 앱&라이프 메인 > 임의의 쇼핑상품 선택 > [<] 선택 시 이전화면 이동
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_GUH_02850() throws Exception {
		TCID = "OSC700_01_Home_02850  임의의 쇼핑상품선택";
		result = "FAIL";
		...
		Thread.sleep(3000);
		assertTrue(driver.findElementById("com.skt.skaf.A000Z00040:id/btn_app_life").isSelected());
		driver.findElementById("com.skt.skaf.A000Z00040:id/priceView").isDisplayed();
