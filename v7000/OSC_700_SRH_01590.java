...
public class OSC_700_SRH_01590 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-21
	 * @ ExpectedResult = 메인 > 검색 > 함께 검색한 상품 영역 > 쇼핑 연관 검색 결과 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_SRH_01590() throws Exception {
		TCID = "OSC700_05_검색_01590 쇼핑 연관 검색 결과 (함께 검색한 상품) 확인";
		result = "FAIL";
