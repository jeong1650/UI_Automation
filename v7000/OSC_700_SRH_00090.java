...
public class OSC_700_SRH_00090 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-15
	 * @ ExpectedResult = 메인 > 검색 > A 검색어 검색 > 검색어 탭 > 검색어 입력 전 상단 back 선택 시 A 검색 결과 화면 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_SRH_00090() throws Exception {
		TCID = "OSC700_05_검색_00090 상단 Back 버튼 선택 (검색어 입력 전인 상태)";
		result = "FAIL";
