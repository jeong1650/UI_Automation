...
public class OSC_700_MYP_05020 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-11
	 * @ ExpectedResult = 마이페이지 > 계정관리 > 이용해지 > 이용 해지 관련 고객 안내 영역 정상 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_05020() throws Exception {
		TCID = "OSC700_04_설정_05020 이용 해지 관련 고객 안내 영역 확인";
		result = "FAIL";
