...
public class OSC_700_GUH_00440 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-08-31
	 * @ ExpectedResult = 게임 추천 화면 > KT 통신 판매업 신고번호 선택 시 KT 공정위 사업자 정보 고지 화면 이동
	 * @ Editor = 
	 * @ EditDate = 2020-10-15
	...
	@Test
	public void OSC_GUH_00440() throws Exception {
		TCID = "OSC700_01_Home_00440 KT 통신 판매업 신고번호 선택";
		result = "FAIL";
