...
public class OSC_700_MYP_04160 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-11
	 * @ ExpectedResult = 마이페이지 > MDN 회원 계정관리 화면 정상 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_04160() throws Exception {
		TCID = "OSC700_04_MY_04160 계정관리 (MDN)";
		result = "FAIL";
