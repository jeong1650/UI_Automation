...
public class OSC_700_MKT_02760 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-28
	 * @ ExpectedResult = 오픈알림 취소 시 팝업 노출
	 * -----------------------------------------------------------------------------
	 */

	@Test
	public void OSC_MKT_02760() throws Exception {
		TCID = "OSC700_08_마케팅_02760 [알림 취소] 선택";
		result = "FAIL";
		...
		Thread.sleep(3000);
		driver.findElementByXPath(makeXPath(textType, "사전예약 시작 알림이 취소되었습니다.")).isDisplayed();
		...
		Thread.sleep(3000);
		assertTrue(driver.findElements(By.xpath(makeXPath(textType, "사전예약 시작 알림이 취소되었습니다."))).size() == 0);
