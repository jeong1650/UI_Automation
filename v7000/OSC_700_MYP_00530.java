...
public class OSC_700_MYP_00530 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-10
	 * @ ExpectedResult = 마이페이지 > 내 쿠폰 > 편집모드 > 쿠폰 삭제 > 종료 선택시 미반영
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_00530() throws Exception {
		TCID = "OSC700_04_MY_00530 [편집] 선택";
		result = "FAIL";
		...
		Thread.sleep(3000);
		assertTrue(driver.findElements(By.id("com.skt.skaf.A000Z00040:id/appbar_complete_actionlayout")).size() == 0);
		
		assertEquals(cpnName, driver.findElementById("com.skt.skaf.A000Z00040:id/titleTextView").getText());
