...
public class OSC_700_MYP_02110 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-11
	 * @ ExpectedResult = 마이페이지 > 구매내역 > 영수증 팝업 > [닫기] 선택 시 이전 화면 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_02110() throws Exception {
		TCID = "OSC700_04_MY_02110 [닫기] 선택";
		result = "FAIL";
		...
		driver.findElementById("com.skt.skaf.A000Z00040:id/close").click();
		
		Thread.sleep(3000);
		assertTrue(driver.findElements(By.id("com.skt.skaf.A000Z00040:id/close")).size() == 0);
