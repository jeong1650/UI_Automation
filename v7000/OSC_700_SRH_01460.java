...
public class OSC_700_SRH_01460 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-18
	 * @ ExpectedResult = 메인 > 검색 > 쇼핑상품 부가정보 A 선택 > B 선택 시 B 정보 노출 / 중복선택 X
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_SRH_01460() throws Exception {
		TCID = "OSC700_05_검색_01460 부가 정보 B tap";
		result = "FAIL";
