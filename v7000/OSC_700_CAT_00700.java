...
public class OSC_700_CAT_00700 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-04
	 * @ ExpectedResult = 게임 / 앱 상품 상세 > 리뷰 등록 페이지 > 타이틀 영역 정상 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_CAT_00700() throws Exception {
		TCID = "OSC700_03_APP_00700 타이틀 영역 확인 (구매 후 미설치 상태)";
		result = "FAIL";
