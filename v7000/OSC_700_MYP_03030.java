...
public class OSC_700_MYP_03030 extends OSC_Base_text {
	...
	@Test
	public void OSC_MYP_03030() throws Exception {
		TCID = "OSC700_04_MY_03030 [종료] 선택";
		result = "FAIL";
		...
		Thread.sleep(3000);
		assertEquals(dltTitle, driver.findElementById("com.skt.skaf.A000Z00040:id/titleTextView").getText());
