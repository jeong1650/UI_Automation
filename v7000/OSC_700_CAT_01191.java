...
public class OSC_700_CAT_01191 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-07
	 * @ ExpectedResult = 유료 게임 / 앱 상품 상세 > 청약철회 및 통신판매 중개 사업자 안내 영역 정상 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_CAT_01191() throws Exception {
		TCID = "OSC700_03_APP_01191 2.청약철회 및 통신판매 중개 사업자 안내 영역 확인";
		result = "FAIL";
