...
public class OSC_700_MKT_02680 extends OSC_Base_text {
	...
	@Test
	public void OSC_MKT_02680() throws Exception {
		TCID = "OSC700_08_마케팅_02680 [전문보기] 선택";
		result = "FAIL";
		...
		try {
			driver.findElementByXPath(makeXPath(textType, "이전페이지 개인정보 수집 및 이용 동의")).click();
		} catch(Exception e) {
			driver.findElementByXPath(makeXPath(textType, "이전페이지")).click();
		}
