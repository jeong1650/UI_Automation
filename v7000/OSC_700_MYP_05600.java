...
public class OSC_700_MYP_05600 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-14
	 * @ ExpectedResult = 마이페이지 > 고객센터 > 이메일 문의 > 이메일 미입력 시 팝업 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_05600() throws Exception {
		TCID = "OSC700_04_설정_05600 이메일 미입력 후 [확인] 선택 (이메일이 입력되지 않은 경우)";
		result = "FAIL";
		...
		assertEquals("이메일을 입력해 주세요.", driver.findElementById("com.skt.skaf.A000Z00040:id/description").getText());
