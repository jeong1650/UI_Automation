...
public class OSC_700_MYP_05430 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-14
	 * @ ExpectedResult = 마이페이지 > 고객센터 > 라이브 채팅 > 상세 항목 미선택 > [상담하기] 시 팝업 노출
	 * @ Editor = 
	 * @ EditDate = 
	 * @ 
	 * -----------------------------------------------------------------------------
	...
	@Test
	public void OSC_MYP_05430() throws Exception {
		TCID = "OSC700_04_설정_05430 상세 항목 미선택 후 [확인] 선택 (제목 2번째 항목이 선택되지 않은 경우)";
		result = "FAIL";
