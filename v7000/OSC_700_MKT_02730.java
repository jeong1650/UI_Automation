...
public class OSC_700_MKT_02730 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-09-28
	 * @ ExpectedResult = 오픈알림 신청 [전문보기] 선택 시 전문 노출
	 * -----------------------------------------------------------------------------
	 */

	@Test
	public void OSC_MKT_02730() throws Exception {
		TCID = "OSC700_08_마케팅_02730 [전문보기] 선택";
		result = "FAIL";
