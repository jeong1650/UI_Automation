...
public class OSC_700_MKT_02830 extends OSC_Base_text {

	/* -----------------------------------------------------------------------------
	 * @ Writer = Park Cheolmin
	 * @ Date = 2020-10-15
	 * @ ExpectedResult = 사전예약 > 모든 게임 예약 ON / 사전예약 시작 알림 OFF
	 * -----------------------------------------------------------------------------
	 */

	@Test
	public void OSC_MKT_02830() throws Exception {
		TCID = "OSC700_08_마케팅_02830 모든 게임 사전예약, 오픈 알림 신청 영역 (모든 게임 예약 ON, 사전예약 시작 알림 OFF인 경우)";
		result = "FAIL";
